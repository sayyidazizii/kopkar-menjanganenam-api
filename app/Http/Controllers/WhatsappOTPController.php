...
class WhatsappOTPController extends Controller
{
    ...
    public function send($member_no)
    {
        ...
        try {
            ...
            //         'number'    => $member_phone,
            //         'token'     => $token,
            //         'message'   => "Kode OTP Anda ".$otp_code." untuk Aplikasi KopKar Menjangan Enam",
            //     ]
            // ]);
            $response = WA::to($member_phone)->msg('Kode OTP Anda'. ".$otp_code." .'untuk Aplikasi KopKar Menjangan Enam');
    ...
    public function testWa(){
        ...
        return WA::to('085602678871')->msg('test wa sender');
    }
}
