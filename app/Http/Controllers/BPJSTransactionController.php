...
class BPJSTransactionController extends Controller
{
    public function apiTrans($data)
    {
        ...
        public function getPPOBBPJS(Request $request){
            ...
            $data['apikey']     = '$2y$10$RM31rL6NuQjiXHrEv3jewe95KtXnXsoVaVZxAdpRzppegAV7AqrUl';
            $data['secretkey']  = '$2y$10$FVsrF6I1m.VtFiWh5gHVe7MdEHVJIsbyV7u5Qiwfw1XBQ.lORaV';
                    ...
                    if($ppob_balance_company < $totalTagihan){
                        ...
                        if($inquiry_data['code'] == 200){
                            ...
                            if($datappob_transactions->save()){
                                ...
                                $data_profitshares->savings_account_id               = $data_post['savings_account_id'];
                            ...
                            $datappob_transaction->savings_account_id               = $data_post['savings_account_id'];
